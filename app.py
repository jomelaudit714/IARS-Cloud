...
def _apply_v4502_transition_refinements() -> None:
    ...
    st.markdown(
        ...
        /* Header coordinates are controlled only by the V4.5.25 fixed-header
...
if page_key == "Settings":
    ...
    render_metric_cards(
        [
            {"label": "IARS Version", "value": "4.5.25", "note": "Actual Streamlit Wrapper Sticky Header Fix", "icon": "⚙️", "accent": "#C78B12"},
