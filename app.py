...
render_app_header(auth_user, version="4.4.94", page_title=page_key)
...
if page_key == "Settings":
    ...
    render_metric_cards(
        [
            {"label": "IARS Version", "value": "4.4.94", "note": "Exact-Reference EDL Enterprise UI", "icon": "⚙️", "accent": "#C78B12"},
